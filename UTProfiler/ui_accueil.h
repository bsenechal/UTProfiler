...
public:
    ...
    void setupUi(QMainWindow *Accueil)
    {
        ...
        inscription->setGeometry(QRect(690, 230, 100, 30));
        input_mdp = new QLineEdit(Connexion);
        input_mdp->setObjectName(QStringLiteral("input_mdp"));
        input_mdp->setGeometry(QRect(650, 190, 150, 25));
        ...
        input_login->setGeometry(QRect(650, 150, 150, 25));
        ...
        connexion->setObjectName(QStringLiteral("connexion"));
        connexion->setGeometry(QRect(574, 230, 100, 30));
