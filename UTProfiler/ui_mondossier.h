...
public:
    ...
    void setupUi(QDialog *mondossier)
    {
        ...
        label_2->setGeometry(QRect(470, 90, 81, 16));
        label_3 = new QLabel(tab_info_perso);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(600, 90, 51, 16));
        ...
        comboBox_credits->setGeometry(QRect(270, 310, 91, 22));
