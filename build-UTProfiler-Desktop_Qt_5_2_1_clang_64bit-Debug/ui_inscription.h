...
public:
    ...
    void setupUi(QDialog *Inscription)
    {
        ...
        valider->setGeometry(QRect(150, 390, 75, 23));
        ...
        label_commentaires->setGeometry(QRect(30, 320, 90, 20));
        ...
        input_commentaires->setGeometry(QRect(130, 320, 151, 61));
        ...
        label_datenaiss->setGeometry(QRect(30, 200, 90, 20));
